!(function (i) {
  ...
  (t = function (t, o) {
    ...
    (n.defaults = {
      ...
      asNavFor: null,
      prevArrow:
        '<button class="slick-prev" aria-label="Previous" type="button"><img class="slick-next" src="images/icons/previous-arrow.svg" alt="Prev"></button>',
      nextArrow:
        '<button class="slick-next" aria-label="Next" type="button"><img class="slick-next" src="images/icons/next-arrow.svg" alt="Next"></button>',
      autoplay: !1,
      autoplaySpeed: 3e3,
      centerMode: !1,
      centerPadding: "50px",
